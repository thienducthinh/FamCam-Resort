...
/* Query 2: Based on the same table definition of Condo, create a duplicate table, New_Condo_A, by using the Select * into statement to populate the new table with all Building A records.*/
